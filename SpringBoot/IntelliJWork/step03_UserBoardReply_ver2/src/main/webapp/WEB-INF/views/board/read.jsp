...
<table align="center" cellpadding="5" cellspacing="2" width="600" border='1'>
    ...
    <tr>
        ...
        <td width="450" height="200" valign="top" colspan="3">
            <span style="font-size:9pt;"><b><xmp>${requestScope.board.content}</xmp></b></span></td>
    </tr>

    <form name="requestForm" method="post" id="requestForm">
        <tr class="align-bottom">
            <td height="20" colspan="4" align="center">
                <!-- 수정 시 필요한 데이터들을 hidden으로 숨겨놓고 폼 데이터로 보내준다. -->
...
<hr>
<div align=right><span style="font-size:9pt;">&lt;<a href="${pageContext.request.contextPath}/board/list">리스트로 돌아가기</a>&gt;</span>
</div>
