...
VALUES
    ('구도연', 'kkamang03@gmail.net', '+1-555-987-6543', 'San Francisco, CA', 6, ARRAY['Java', 'Spring Boot', 'Hibernate', 'AWS']),
    ('이찬범',  'chan@naver.com',   '+1-555-234-5678', 'Austin, TX', 5, ARRAY['Go', 'gRPC', 'Kubernetes', 'PostgreSQL']);
